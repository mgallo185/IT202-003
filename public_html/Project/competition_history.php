...
//handle page load
$stmt = $db->prepare(
"SELECT Competitions.id , title, min_participants, current_participants, current_reward, expires, creator_id, min_score, join_cost, IF(comp_id is null, 0, 1) as joined,  CONCAT(first_place,'% - ', second_place, '% - ', third_place, '%') as place FROM Competitions
JOIN Competitions on Competitions.id = Competitions.payout_option
...
<div class="container-fluid">
    <h1>Competition History: <?php se($comp); ?></h1>
